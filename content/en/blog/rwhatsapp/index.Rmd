...
tags: ["R", "Whatsapp", "Visualisation", "rwhatsapp"]
subtitle: ''
...
`Whatsapp` est une application de messagerie instantanée et aussi un  réseau social qui nous donne la simplicité de communiquer avec nos proches et amis, grâce à ses capacités de chat et d'échange en groupe. Ainsi, nous générons de tas de données par nos échanges. Comment visualiser et analyser ces données? Dans cet tutoriel, il est question de montrer comment nous pouvons visualiser et analyser nos données **Whatsapp** sous **R** avec le package [rwhatsapp](https://cran.r-project.org/web/packages/rwhatsapp/).


```{r, echo = FALSE}
knitr::include_graphics("SN.gif", error = FALSE)
```
...
```{r, echo = FALSE}
knitr::include_graphics("whap_etap.png", error = FALSE)
```
